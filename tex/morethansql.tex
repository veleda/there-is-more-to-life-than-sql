...
\begin{frame}
\begin{center}
\includegraphics[width=0.9\textwidth]{img/gartner.png}
\end{center}
\end{frame}
...
VocabularyA collection of words, concepts, terms (and/or RDF resources).
TaxonomyA classification of the vocabulary.
Ontology A set of concepts and categories that shows their properties and
relations between them. Including accessible semantics and logic.
